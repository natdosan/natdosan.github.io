...
- **Description**: Our final model has 4 additional categorical features, **'has_good_in_review'**, **'has_bad_in_review'**, **'high_calories'**, and **'has_sugar'** in addition to to the original features in the first model. 
